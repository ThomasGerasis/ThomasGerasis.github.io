...
<div id="comments" class="">
    ...
    $args = array(
            ...
            '</div>
                                                                ...
                                                                <div class="col-sm-10 col-12">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="comment">Το σχόλιο σου</label>
        ...
        'logged_in_as' => '<p class="text-center">('. sprintf(
                __( 'Συνδεδεμένος ως <a href="%1$s">%2$s</a>. <a href="%3$s" title="Log out of this account">Αποσύνδεση ?</a>' ),
        ...
        'label_submit' => 'Εισαγωγή '

    );
    ?>
    <!--Leave a reply section-->
    <div class="card mb-3 wow fadeIn">
        <div class="card-header font-weight-bold">Αφήστε μας μία απάντηση</div>
        <div class="card-body">
